...
public class HibernateConfiguration {
	...
	public static SessionFactory getSessionFactory() {
		...
		prop.put(Environment.JAKARTA_JDBC_URL, "jdbc:mysql://localhost:3306/hibernate");
...
//		SessionFactory sessionFactory = metadata.buildSessionFactory();
		...
		return new MetadataSources(new StandardServiceRegistryBuilder().applySettings(prop).build())
				.addAnnotatedClass(com.learning.hbn.entity.Student.class).buildMetadata().buildSessionFactory();
